...
<div class="justify-center h-screen bg-gray-100">
    <center class="m-auto mt-24">
        <span class="mt-4 tracking-widest text-xl text-gray-500">Internal Server Error</span>

        <svg class="emoji-500 " enable-background="new 0 0 226 249.135" height="249.135" id="Layer_1" overflow="visible"
    ...
    <center class="mt-6">
        <a href="{{url()->previous()}}"
            class="p-3 font-mono text-xl text-gray-500 bg-gray-200 rounded-md hover:shadow-md">Trở về trang trước! </a>
    </center>
</div>
