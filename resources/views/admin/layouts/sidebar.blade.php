    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-r from-green-400 to-red-300 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{route('admin.user.admin')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Admins
                            + Staffs</a>
                    </li>
                    <li>
                        <a href="{{route('admin.user.seller')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sellers
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.user.upgrade_request')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Seller
                            Request
                        </a>
                    </li>
                </ul>
            ...
            <li class="p-2">
                <button type="button"
                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="E-commerce-drop" data-collapse-toggle="E-commerce-drop">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul id="E-commerce-drop" class="hidden py-2 space-y-2">
                    <li>
                    ...
                    <li>
                        <a href="{{route('admin.orders.index')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Order
                            Reports</a>
                    </li>
                </ul>
            </li>
            <li class="p-2">
                <button type="button"
                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="money-drop" data-collapse-toggle="money-drop">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Funds</span>
                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                ...
                <ul id="money-drop" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{route('admin.deposit.index')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Deposits</a>
                    </li>
                    <li>
                        <a href="{{route('admin.withdraw.index')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Withdraws</a>
                    </li>
                    <li>
                        <a href="{{route('admin.gateway.index')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Gateways</a>
                    </li>
                </ul>
            </li>
            <li class="p-2">
            ...
            <li class="p-2">
                <a href="{{route('admin.giftcode.index')}}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">GiftCode</span>
                </a>
            </li>
            <li class="p-2">
                <button type="button"
