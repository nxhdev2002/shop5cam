...
<script>
    function updateWebConfig() {
        ...
        let guarantee_time = $('#guarantee_time').val()
        $.ajax({
...
<main class="p-4 sm:ml-64">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="upgrade_fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phí nâng
                    cấp lên
                    người bán (VNĐ)</label>
            ...
            <div>
                <label for="order_fixed_fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phí cố
                    định / giao
                    dịch (VNĐ)</label>
            ...
            <div>
                <label for="order_percent_fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phí
                    phần trăm /
                    giao dịch (%)</label>
            ...
            <div>
                <label for="guarantee_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Thời
                    gian bảo hành
                    (ngày)</label>
                <input type="tel" id="guarantee_time"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    value="{{$webConfig->guarantee_time}}" required>
            </div>
        </div>
