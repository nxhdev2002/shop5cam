        ...
        <main class="h-full overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                <div class="grid gap-8 md:grid-cols-2 xl:gird-rows-2">
                    <div class="flex items-center justify-start p-4 bg-white rounded-lg shadow-sm dark:bg-gray-800">
                        <div
                    ...
                    <div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="method" class="form-select mt-1 block w-full rounded-lg shadow-sm"
                                    required>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="contact_info"
                                    class="form-textarea mt-1 block w-full rounded-lg shadow-sm" rows="3"
                                    required></textarea>
                            </div>
