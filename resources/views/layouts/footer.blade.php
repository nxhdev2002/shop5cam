<script src="https://kit.fontawesome.com/65e99e0ea6.js" crossorigin="anonymous"></script>
<footer aria-label="Site Footer" class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-start lg:gap-8">
            <div class="text-orange-600 dark:text-teal-300">
                ...
                <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                    <form class="w-full">
                        ...
                        <div
                            ...
                            <button
                                class="mt-1 w-full bg-orange-600 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:flex-shrink-0">
                                Sign Up
                            </button>
                        </div>
                    </form>
